    ...
    public GamesFactory DesertBluffs()
    {
        ...
        return this
            .WithGame(attr.Name, attr.Description!)
                .WithIsDynamic()
                .WithImagePath("/static/desert-bluffs/the-road.png")
                .WithLocation()
...
Outside the building there is a small shelf area where patrons may clearly gather with their drinks.")
                    .WithImagePath("/static/desert-bluffs/american-spirit/Exterior.png")
                    .WithArea()
                        .WithName("Main Bar")
                        .WithImagePath("/static/desert-bluffs/american-spirit/Interior.png")
...
* A softer seating area: a couch or a couple of old recliners where vets can sit back and talk in a more relaxed setting.")
                    ...
                    .WithItemLink()
                        .WithItem()
                            ...
                            .WithImagePath("/static/desert-bluffs/items/map.jpg")
                            ...
                            .WithAttachment()
                                ...
                                .WithPath("/static/desert-bluffs/items/map.jpg")
                            .End()
                            .WithId("map")
                        .End()
                    .End()
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Thomas-Yazzie.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Bly Yazzie")
                            .WithImagePath("/static/desert-bluffs/Bly-Yazzie.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Jamal-Freeman.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Malik-and-Aaliyah-Freeman.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Carlos-Rivera.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Charlie-Thompson.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Bob-Anderson.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Jim Harris")
                            .WithImagePath("/static/desert-bluffs/Jim-Harris.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Jimmy-Turner.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Sam-Mitchell.png")
                ...
                .WithLocation()
                    ...
                    .WithImagePath("/static/desert-bluffs/desert-bites/Exterior.png")
...
* The diner has a payphone near the entrance.")
                        .WithImagePath("/static/desert-bluffs/desert-bites/Interior.png")
...
* The menu is limited but always includes a meat option and a vegetarian option, ensuring that there’s something for everyone.")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Betty-White.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Lizzy-Black.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Lily-Yazzie.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Scott-Graham.png")
                    ...
                    .WithItemLink()
                        .WithItem()
                            ...
                            .WithImagePath("/static/desert-bluffs/items/Desert-Bites-Diner-Menu.png")
                            .WithAttachment()
                                .WithName("The Menu")
                                .WithDescription("A PDF version of the Desert Bites Diner Menu")
                                .WithPath("/static/desert-bluffs/items/Desert-Bites-Diner-Menu.pdf")
                            .End()
                            .WithAttachment()
                                .WithName("Monday Specials")
                                .WithDescription("Specials on a Monday")
                                .WithPath("/static/desert-bluffs/items/Desert-Bites-Diner-Menu/specials-Monday.png")
                            .End()
                            .WithAttachment()
                                .WithName("Tuesday Specials")
                                .WithDescription("Specials on a Tuesday")
                                .WithPath("/static/desert-bluffs/items/Desert-Bites-Diner-Menu/specials-Tuesday.png")
                            .End()
                            .WithAttachment()
                                .WithName("Wednesday Specials")
                                .WithDescription("Specials on a Wednesday")
                                .WithPath("/static/desert-bluffs/items/Desert-Bites-Diner-Menu/specials-Wednesday.png")
                            .End()
                            .WithAttachment()
                                .WithName("Thursday Specials")
                                .WithDescription("Specials on a Thursday")
                                .WithPath("/static/desert-bluffs/items/Desert-Bites-Diner-Menu/specials-Thursday.png")
                            .End()
                            .WithAttachment()
                                .WithName("Friday Specials")
                                .WithDescription("Specials on a Friday")
                                .WithPath("/static/desert-bluffs/items/Desert-Bites-Diner-Menu/specials-Friday.png")
                            .End()
                            .WithAttachment()
                                .WithName("Weekend Specials")
                                .WithDescription("Specials on a Weekend")
                                .WithPath("/static/desert-bluffs/items/Desert-Bites-Diner-Menu/specials-Weekend.png")
                            .End()
                            .WithId("diner-menu")
                        .End()
                    .End()
                ...
                .WithLocation()
                    ...
                    .WithImagePath("/static/desert-bluffs/desert-view/Exterior.png")
...
Desert View is a Tidal Dynamics facility, but this is kept very, very low key. The call and response phrase ‘uncommon paths’ coupled with ‘light on’ will unlock more information from the shift managers about some of their guests.")
                    ...
                    .WithArea()
                        ...
                        .WithImagePath("/static/desert-bluffs/desert-view/Interior-Living-Area.png")
                    .End()
                    .WithArea()
                        .WithName("Bedrooms")
...
The attached ensuite bathroom includes a walk-in shower, grab rails, and non-slip flooring. The room is quiet, functional, and free of personal decoration unless added by the resident or their family.")
                        .WithImagePath("/static/desert-bluffs/desert-view/Interior-Bedroom.png")
                    .End()
                    .WithItemLink("map")
                    .WithItemLink()
                        .WithItem()
                            .WithName("Letter From Raj Patel")
                            .WithImagePath("/static/desert-bluffs/items/Letter-from-Raj-Patel.png")
                            .WithAttachment()
                                .WithName("The Letter")
                                .WithPath("/static/desert-bluffs/items/Letter-from-Raj-Patel.png")
                            .End()
                    ...
                    .WithItemLink()
                        .WithItem()
                            ...
                            .WithImagePath("/static/desert-bluffs/items/raj-drawing.png")
                            .WithAttachment()
                                .WithName("The Drawing")
                                .WithPath("/static/desert-bluffs/items/raj-drawing.png")
                            .End()
                            .WithId("raj-drawing")
                        .End()
                    .End()
...
Placement and Condition: The staff rests carefully beside Raj’s bed, wrapped in a cloth embroidered with sacred symbols. It shows signs of long use but is well cared for, with faint scratches hinting at battles fought or trials endured. The inscriptions are slightly worn, suggesting Raj’s devotion endured until the end.")
                            .WithImagePath("/static/desert-bluffs/items/raj-walking-stick.png")
                            .WithAttachment()
                                .WithName("The Walking Stick")
                                .WithPath("/static/desert-bluffs/items/raj-walking-stick.png")
                            .End()
...
* His health continued to decline, and he is now 100 years old.")
                            .WithImagePath("/static/desert-bluffs/Malcolm-Tetherwall.png")
...
***Hello, this is Eloise Rainer. I’m one of the managers here at Desert View, in Desert Bluffs. We have a resident here, Mr Raj Patel. I’m sorry to let you know that Raj has reached the end of his lifespan with us here on earth – he is in the process of dying. He may not have long left, and he has asked us to reach out to you. He has walked an uncommon path through life and wishes you to be with him at the end.***")
                            .WithImagePath("/static/desert-bluffs/Eloise-Rainer.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Adam Rios")
                            .WithImagePath("/static/desert-bluffs/Adam-Rios.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Jazz-Carter.jpg")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Edna-Mallory.png")
...
* If players ask about the school or mention Luke, she shares what she remembers — no records, only her story")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Father-Kevin-Flowers.png")
...
Inside, the shop is sparse but tidy: a few shelves of snacks, fridges humming in the back, a tired coffee machine, and a small counter with a good view of the forecourt. Security cameras are obvious. A locked door marked “Staff Only” leads somewhere behind the drinks fridges.")
                    .WithImagePath("/static/desert-bluffs/gas-n-go/Exterior.png")
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Lucia Morales")
                            .WithImagePath("/static/desert-bluffs/Lucia-Morales.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Paul-Johnson.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/David-Inoue.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Jordan-Reyes.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Jake-Kowalski.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Ellen-Kowalski.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Jacob-Kowalski.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Evelyn-Martinez.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Charlie-Hoskin.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Tina-Wallace.png")
                    ...
                    .WithItemLink()
                        .WithItem()
                            ...
                            .WithImagePath("/static/desert-bluffs/items/Gas-n-Go-Opening-hours.png")
                            .WithAttachment()
                                .WithName("Opening Hours")
                                .WithPath("/static/desert-bluffs/items/Gas-n-Go-Opening-hours.png")
                            .End()
                        .End()
                    .End()
                    .WithId("gas-n-go")
...
Even in daylight, the place casts a long shadow. The heat seems quieter here. The kind of quiet that doesn’t welcome visitors but watches them instead.")
                    .WithImagePath("/static/desert-bluffs/radio-station/Exterior.png")
                    .WithItemLink()
                        .WithItem()
                            .WithName("Tape - S.W. Overnight Broadcast")
                            .WithImagePath("/static/desert-bluffs/items/TAPE-overnight-s.w.-broadcast.png")
                            .WithAttachment()
                                .WithName("Audio")
                                .WithPath("/static/desert-bluffs/items/overnight-s.w.-broadcast.mp3")
                            .End()
                            .WithAttachment()
                                .WithName("Transcript")
                                .WithPath("/static/desert-bluffs/items/overnight-s.w.-broadcast-transcript.pdf")
                            .End()
                            .WithAttachment()
                                .WithName("Decoded")
                                .WithPath("/static/desert-bluffs/items/overnight-s.w.-broadcast-decoded.pdf")
                            .End()
                            .WithId("tape-1")
                        .End()
                    .End()
                    .WithItemLink()
                        .WithItem()
                            ...
                            .WithImagePath("/static/desert-bluffs/items/TAPE-Shadows-in-the-Heartland.jpg")
                            .WithAttachment()
                                .WithName("Audio")
                                .WithPath("/static/desert-bluffs/items/Shadows-in-the-Heartland.wav")
                            .End()
                            .WithAttachment()
                                .WithName("Transcript")
                                .WithPath("/static/desert-bluffs/items/Shadows-in-the-Heartland-transcript.pdf")
                            .End()
                            .WithId("tape-2")
                        .End()
                    .End()
...
The building is modern—single-storey, flat-roofed, with smooth grey brickwork, reddish orange neon signage, and lots of big glass display windows. The sidewalk outside is clear and uncluttered, no ice machines, no vending units.")
                    .WithImagePath("/static/desert-bluffs/convenience-store/Exterior.png")
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Sarah Sharma")
                            .WithImagePath("/static/desert-bluffs/Sarah-Sharma.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Tommy-Nguyen.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Molly-Rivera.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Evan-Michaels.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Dolores-Keene.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Sam-Watkins.png")
                    ...
                    .WithItemLink()
                        .WithItem()
                            ...
                            .WithImagePath("/static/desert-bluffs/items/Opening-Hours-Lakeside-Drive-Convenience-Store.png")
                    ...
                    .WithItemLink()
                        .WithItem()
                            ...
                            .WithImagePath("/static/desert-bluffs/items/Sarah-Sharmas-Incident-Log.png")
                            .WithAttachment()
                                .WithName("The Incident Log")
                                .WithDescription("A PDF version of the incident log")
                                .WithPath("/static/desert-bluffs/items/Sarah-Sharmas-Incident-Log.pdf")
                            .End()
                ...
                .WithLocation()
                    .WithName("McDoonalls")
                    .WithImagePath("/static/desert-bluffs/mcdoonalls/Exterior.png")
                    .WithItemLink()
                        .WithItem()
                            .WithName("McDoonalls Menu")
                            .WithImagePath("/static/desert-bluffs/items/McDoonalls-Menu.png")
                            .WithAttachment()
                                .WithName("The Menu")
                                .WithDescription("A PDF version of the menu")
                                .WithPath("/static/desert-bluffs/items/McDoonalls-Menu.pdf")
                            .End()
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Maya Kaur")
                            .WithImagePath("/static/desert-bluffs/Maya-Kaur.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Ethan-Jackson.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Aisha Khan")
                            .WithImagePath("/static/desert-bluffs/Aisha-Khan.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Nina Lee")
                            .WithImagePath("/static/desert-bluffs/Nina-Lee.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Oliver-Chen.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Ava-Johnson.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Jacob-Smithy.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Marcus-Wells.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Ahmed-El-Sayed.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Jimmy-Parker.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Naomi-Chang.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Mila-Redbird.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Ravi-Sharma.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            ...
                            .WithImagePath("/static/desert-bluffs/Chloe-Hayes.png")
                    ...
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Sam Rivera")
                            .WithImagePath("/static/desert-bluffs/Sam-Rivera.png")
...
* The store contains almost anything mundane and reasonable that the players want to buy.")
                    .WithImagePath("/static/desert-bluffs/nuts-n-screws/Exterior.png")
                    .WithCharacterLink()
                        .WithCharacter()
                            .WithName("Harold 'Harry' Harrison")
                            .WithImagePath("/static/desert-bluffs/Harry-and-Gene-Harrison.png")
...
* The building is old fashioned and does not have accessible features or unisex facilities.")
                    .WithImagePath("/static/desert-bluffs/sheriffs-office/Exterior.png")
                    .WithItemLink("map")
                    .WithItemLink()
                        .WithItem()
                            .WithName("Poster: Buckle Up")
                            .WithImagePath("/static/desert-bluffs/items/Buckle-Up.png")
                        .End()
                    .End()
                    .WithItemLink()
                        .WithItem()
                            .WithName("Poster: Bake Sale")
                            .WithImagePath("/static/desert-bluffs/items/Bake-Sale.png")
                        .End()
                    .End()
                    .WithItemLink()
                        .WithItem()
                            .WithName("Sherriff's Office Note")
                            .WithImagePath("/static/desert-bluffs/items/Sheriffs-Office-note-as-found.png")
                            .WithAttachment()
                                .WithName("As Found")
                                .WithPath("/static/desert-bluffs/items/Sheriffs-Office-note-as-found.png")
                            .End()
                            .WithAttachment()
                                .WithName("Cleared up")
                                .WithPath("/static/desert-bluffs/items/Sheriffs-Office-note-clearer.png")
                            .End()
                        .End()
                    .End()
                    .WithItemLink()
                        .WithItem()
                            ...
                            .WithImagePath("/static/desert-bluffs/items/Incident-Report.png")
                            .WithAttachment()
                                .WithName("The Report")
                                .WithPath("/static/desert-bluffs/items/Incident-Report.png")
                            .End()
                        .End()
                    .End()
                    .WithCharacterLink()
...
* Occasional bird nests and vermin droppings around vents and eaves")
                    .WithImagePath("/static/desert-bluffs/school-and-field/Exterior.png")
                    .WithItemLink()
                        .WithItem()
                            .WithName("School Graffiti #1")
                            .WithImagePath("/static/desert-bluffs/school-and-field/graffiti-1.jpg")
                        .End()
                    .End()
                    .WithItemLink()
                        .WithItem()
                            .WithName("School Graffiti #2")
                            .WithImagePath("/static/desert-bluffs/school-and-field/graffiti-2.jpg")
                        .End()
                    .End()
                    .WithItemLink()
                        .WithItem()
                            .WithName("School Graffiti #3")
                            .WithImagePath("/static/desert-bluffs/school-and-field/graffiti-3.jpg")
                        .End()
                    .End()
                ...
                .WithLocation()
                    ...
                    .WithImagePath("/static/desert-bluffs/house-behind-diner/Exterior.png")
                    .WithCharacterLink()
...
To the left of the building is a long, empty warehouse, its exterior just as neglected, with faded graffiti scrawled on the walls. The once vibrant colours of the street art have long since dulled, giving it a forgotten, desolate air. Old equipment and parts lie scattered around the back, overrun with rust and corrosion. The smell of rust, mildew, and dust lingers in the air.")
                    .WithImagePath("/static/desert-bluffs/suncrest-communications/Exterior.png")
